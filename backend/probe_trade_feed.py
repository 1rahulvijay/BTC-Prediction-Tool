...
Usage:
  python backend/probe_trade_feed.py            # ~20s live count (run on the box that runs the app)
  python backend/probe_trade_feed.py --secs 30
  python backend/probe_trade_feed.py --selftest # validates the message parser offline
"""
