...
Usage:
  python backend/probe_model_bakeoff.py            # full bakeoff (5m + 15m) + meta-labeling
  python backend/probe_model_bakeoff.py --tcn      # also run the torch sequence model (slower)
  python backend/probe_model_bakeoff.py --selftest
"""
