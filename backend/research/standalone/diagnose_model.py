...
Usage:  python backend/research/standalone/diagnose_model.py  [--db PATH] [--bottom 15]
"""
...
def main():
    ...
    ap.add_argument("--db", default=os.environ.get("BTC_DB_PATH") or os.path.join(
        os.environ.get("BTC_DATA_DIR") or os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "data"),
        "analytics.duckdb"))
