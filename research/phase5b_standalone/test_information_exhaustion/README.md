# P5B_57_INFORMATION_EXHAUSTION

## Question

Does intense activity predict exhaustion?
...
```powershell
python research\phase5b_standalone\test_information_exhaustion\run.py `
  --data-dir data `
  --output data\research\phase5b_standalone\test_information_exhaustion\RUN_ID `
  --seed 20260802
```
