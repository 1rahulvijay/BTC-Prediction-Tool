...
Usage:
  python backend/probe_impact_residual.py            # full matrix
  python backend/probe_impact_residual.py --days 30  # recent window only
  python backend/probe_impact_residual.py --selftest # validate the logic on synthetic data
"""
