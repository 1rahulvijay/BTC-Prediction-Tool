...
Usage:
  python backend/research/standalone/probe_impact_reversion.py --horizon 5 --impulse-bars 3 --cond-pct 70 --drop 50
...
DATA_DIR = os.environ.get("BTC_DATA_DIR") or os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "data")
