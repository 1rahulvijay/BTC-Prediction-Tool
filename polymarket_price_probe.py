...
Usage:
    python polymarket_price_probe.py            # light: gamma + pyth + binance
    python polymarket_price_probe.py --scrape   # also run the Playwright scrape
    python polymarket_price_probe.py --once     # one window then exit (quick reachability test)
