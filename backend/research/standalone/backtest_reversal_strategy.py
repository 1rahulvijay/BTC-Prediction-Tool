...
Usage:
  python backend/research/standalone/backtest_reversal_strategy.py                          # instant: existing 360d 1m matrix
  python backend/research/standalone/backtest_reversal_strategy.py --source binance --interval 30s --days 180   # fetch sub-minute
  python backend/research/standalone/backtest_reversal_strategy.py --selftest
"""
