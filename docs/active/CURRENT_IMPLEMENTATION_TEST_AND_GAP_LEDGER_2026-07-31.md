...
- the temporary 30-day full-pipeline smoke retrain has not completed; the 900-day release follows it.
...
| configured historical window | 30 days |
...
**How:** first run the 30-day/95-5 pipeline smoke; then restore 900-day/98-2, evaluate the purged
recent 2%, generate OOF calibration, refit
...
The 30-day run proves pipeline execution only. The later 900-day training run is itself a
prerequisite, not proof of accuracy or profit.
