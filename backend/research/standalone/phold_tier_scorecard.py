...
Usage:  python backend/research/standalone/phold_tier_scorecard.py          (reads the live DB, app stopped)
        python backend/research/standalone/phold_tier_scorecard.py --selftest
"""
