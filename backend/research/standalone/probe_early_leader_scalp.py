...
Usage:  python backend/research/standalone/probe_early_leader_scalp.py [--latency 0|1]
        python backend/research/standalone/probe_early_leader_scalp.py --selftest
"""
