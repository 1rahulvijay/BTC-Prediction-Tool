...
(detailed V8 themes) and the change-audit [V3_CHANGES_AND_AUDIT.md](V3_CHANGES_AND_AUDIT.md) §5ba–§5bv.
...
- Docs: MEASUREMENT_WINDOW, SPEC_ACCURACY_NEXT_RETRAIN, IMPLEMENTATION_QUEUE, NEXT_STEPS_AND_STRATEGY,
  DATA_COLLECTORS, RETRAIN_RUNBOOK, V8_ROADMAP, betting-guide section, change-audit §5ba–§5bv.
