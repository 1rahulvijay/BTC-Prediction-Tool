# P5B_65_PATH_EFFICIENCY_RATIO

## Question

Does efficient path shape predict continuation?
...
```powershell
python research\phase5b_standalone\test_path_efficiency_ratio\run.py `
  --data-dir data `
  --output data\research\phase5b_standalone\test_path_efficiency_ratio\RUN_ID `
  --seed 20260802
```
