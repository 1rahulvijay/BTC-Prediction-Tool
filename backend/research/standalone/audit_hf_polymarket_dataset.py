...
Usage:
  python backend/research/standalone/audit_hf_polymarket_dataset.py            # markets + resolutions (full) + 3 sample orderbook days
  python backend/research/standalone/audit_hf_polymarket_dataset.py --ob-days 6
"""
