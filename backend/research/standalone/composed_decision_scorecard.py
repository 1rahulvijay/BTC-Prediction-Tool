...
Usage:  python backend/research/standalone/composed_decision_scorecard.py            (reads the live DB, app stopped)
        python backend/research/standalone/composed_decision_scorecard.py --selftest (synthetic; no DB)
"""
