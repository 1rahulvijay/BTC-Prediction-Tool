# P5B_85_CANDIDATE_EVIDENCE_COMPLETENESS

## Question

Is candidate evidence complete?
...
```powershell
python research\phase5b_standalone\test_candidate_evidence_completeness\run.py `
  --data-dir data `
  --output data\research\phase5b_standalone\test_candidate_evidence_completeness\RUN_ID `
  --seed 20260802
```
