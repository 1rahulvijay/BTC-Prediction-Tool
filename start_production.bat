...
REM actual trained window or strict serving will reject it as a 3-day mismatch. Production stays
REM pinned to the planned 900-day release and deliberately rejects the temporary 30-day smoke bundle.
