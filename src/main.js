...
function renderTradesBlotter(d) {
  ...
  const ruleName = r => ({MID_SCALP_LIVE_V1:'Mid-round scalp',TP_OR_SETTLE_LIVE_V1:'Early profit-take',STRADDLE_LIVE_V1:'Straddle (blind)',MODEL_FADE_LIVE_V1:'🧠 Model fade',MODEL_STRADDLE_LIVE_V1:'🧠 Model straddle',MODEL_SEQUENTIAL_REVERSAL_V1:'🧠 Sequential reversal',MODEL_RIDE_LIVE_V1:'🧠 Model ride',CHAMPION_DYNAMIC_PAPER_V1:'🧠 Champion dynamic exit',LATE_LEADER_30S_V1:'📜 LATE_LEADER_30S (frozen rule)',LATE_LEADER_15M_SHADOW_V1:'📜 Late-leader 15m (shadow)',LATE_LEADER_15S_V1:'⏱ Late-leader @15s',LATE_LEADER_60S_V1:'⏱ Late-leader @60s',LATE_LEADER_MAKER_V1:'🪑 Maker (rest at bid)',CHEAP_SAFE_EARLY_V1:'💰 Cheap-SAFE early',SHOCK_SNIPER_LIVE_V1:'⚡ Shock sniper',MODEL_CROSSFLIP_L1_V1:'🔀 Cross-flip leg 1',MODEL_CROSSFLIP_L2_V1:'🔀 Cross-flip leg 2',PM_CALIBRATED_FAIR_VALUE_FORWARD_BENCHMARK_V1:'🎯 Calibrated fair value'}[r]||r);
...
function renderDeadStrategiesPanel(ruleStatus) {
  ...
  const rows = [
    ...
    ['🧠 Champion dynamic exit', 'existing Champion authorizes entry; executable bid plus live P(Hold) controls exit', 'Champion-gated', 'new forward paper test', 'CHAMPION_DYNAMIC_PAPER_V1', 'Cannot weaken Champion. Enters only on its explicit positive post-fee PAPER_BET; exits on net target/stop, model invalidation, edge decay or last-chance risk.'],
