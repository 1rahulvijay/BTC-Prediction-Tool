...
Usage:  python backend/research/standalone/probe_champion_ask_lift.py          # full run (needs the zip + matrix)
        python backend/research/standalone/probe_champion_ask_lift.py --selftest
"""
