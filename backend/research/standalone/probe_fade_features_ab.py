...
Usage:
  python backend/research/standalone/probe_fade_features_ab.py            # 5m A/B (stride-subsampled for speed)
  python backend/research/standalone/probe_fade_features_ab.py --selftest
"""
