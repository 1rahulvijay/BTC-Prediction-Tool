# P5B_77_SKIP_REASON_ECONOMIC_VALUE

## Question

Which skip reasons avoid losses?
...
```powershell
python research\phase5b_standalone\test_skip_reason_economic_value\run.py `
  --data-dir data `
  --output data\research\phase5b_standalone\test_skip_reason_economic_value\RUN_ID `
  --seed 20260802
```
